			...
			topMessage : function(){
				...
				if(tm.length){
					...
					button.add(x).one( click_event, function(ev){
						...
						A13F.cookieExpire('saturnwp_top_msg=closed', 7*24);//7 days
					});
				}
			},
					...
					var $items_list		= $container.prevAll('.gallery-media-collection'),
						...
						commentItem = function(ev){
							...
							textarea
								...
								$.ajax({
									...
									url: G.ajaxurl,
									data: {
										action  : 'saturnwp_comment_album_item',
						...
						approveItem = function(ev){
							...
							$.ajax({
								...
								url: G.ajaxurl,
								data: {
									action  : 'saturnwp_mark_album_item',
									security: G.proofing_nonce,
									album_id: album_id,
									item_id : item_id,
									link    : item_id === 'external' ? original_item.data('src') : '',
						...
						finishProofing = function(ev){
							...
							$.ajax({
								...
								url: G.ajaxurl,
								data: {
									action  : 'saturnwp_album_finished_proofing',
									security: G.proofing_nonce,
									album_id: G.album_id
								},
								dataType : 'json'

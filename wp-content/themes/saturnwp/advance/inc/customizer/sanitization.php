 ...
 * @return string
 */
function saturnwp_sanitize_image($value) {
 ...
 * @return string
 */
function saturnwp_sanitize_options($value, $setting) {
 ...
 * @return string
 */
function saturnwp_sanitize_button_set_multi($value, $setting) {
	if(!is_array($value)){
 ...
 * @return string
 */
function saturnwp_sanitize_color($value) {
	if ( empty( $value ) ) {
		return '';
	}
 ...
 * @return string
 */
function saturnwp_sanitize_wp_kses_data($value) {
 ...
 * @return string
 */
function saturnwp_sanitize_esc_html($value) {

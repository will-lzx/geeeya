 ...
 */
function saturnwp_make_css_rule($property, $value, $format = false, $special = ''){
 ...
 * @return string
 */
function saturnwp_hex2rgba( $hex, $opacity = 1 ) {
...
function saturnwp_is_woocommerce_activated() {
 ...
 * @return bool
 */
function saturnwp_is_home_server(){
	return apply_filters('saturnwp_is_home_server', false);
}
 ...
 * @return string
 */
function saturnwp_proper_page_template_name($name){
 ...
 */
function saturnwp_enable_user_css_functions(){
 ...
 */
function saturnwp_meta_get_user_sidebars(){
	global $saturnwp_a13;

	$user_sidebars = $saturnwp_a13->get_option( 'custom_sidebars' );
 ...
 */
function saturnwp_bg_fit_helper($option){
	if($option === ''){
		return '';
	}
 ...
 *
 */
function saturnwp_minify_css($css){
 ...
 *
 */
function saturnwp_read_contents($file){

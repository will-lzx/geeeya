...
<div class="formatter">
    ...
    <h2 class="post-title"<?php saturnwp_schema_args('headline'); ?>>
        <a href="<?php echo esc_url($_link); ?>"<?php saturnwp_schema_args('url'); ?>><?php the_title(); ?><i class="post-format-link-icon fa fa-external-link"></i></a>
    </h2>

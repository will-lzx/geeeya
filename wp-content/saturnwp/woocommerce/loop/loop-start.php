...
global $saturnwp_a13;
$product_variant = $saturnwp_a13->get_option( 'shop_products_variant' );
$product_subvariant = $product_variant === 'under'? ('products_subvariant_'.$saturnwp_a13->get_option( 'shop_products_subvariant' ) ) : '';
$columns_class = function_exists('wc_get_loop_prop')? ' columns-'.wc_get_loop_prop( 'columns' ) : '';
$bonus_classes = 'products_variant_'.$product_variant.' '.$product_subvariant.$columns_class;
$lazy_load       = $saturnwp_a13->get_option( 'shop_lazy_load' ) === 'on';
$lazy_load_mode  = $saturnwp_a13->get_option( 'shop_lazy_load_mode' );

 ...
 *
 */
class SaturnWp_A13_Customize_Spacing_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$this->side_labels = array(
			'top' => esc_html__( 'Top', 'saturnwp' ),
			'right' => esc_html__( 'Right', 'saturnwp' ),
			'bottom' => esc_html__( 'Bottom', 'saturnwp' ),
	 ...
	 *
	 * @see SaturnWp_A13_Customize_Spacing_Control::content_template()
	 */
	...
	public function content_template() {
		...
		<div class="customize-control-content">
			...
			<label class="screen-reader-text" for="{{ id_prefix }}{{ mode }}-unit"><?php esc_html_e( 'Unit', 'saturnwp' ); ?></label>

...
if ( ! defined( 'ABSPATH' ) ) {
    ...
    //SATURNWP_NO_SIDEBARS - prevents displaying sidebar
	if( !defined('SATURNWP_NO_SIDEBARS') ){
        $sidebar = saturnwp_has_active_sidebar();
        if($sidebar !== false){
	        $meta_id = false;
            ...
            echo wp_kses_post('<aside id="secondary" class="widget-area" role="complementary"'.saturnwp_get_schema_args( 'sidebar' ).'>');

...
if ( ! class_exists( '\SktThemes\PageTemplatesDirectory' ) ) {
	...
	class PageTemplatesDirectory {
		...
		public function import_elementor( \WP_REST_Request $request ) {
			...
			if($template_name=='Wedding Cards Home' || $template_name=='Wedding Cards About' || $template_name=='Wedding Cards' || $template_name=='Wedding Cards Contact' || $template_name=='Extreme Sports Home' || $template_name=='Extreme Sports About' || $template_name=='Extreme Sports Activities' || $template_name=='Extreme Sports Contact' || $template_name=='Mechanic Home' || $template_name=='Mechanic About' || $template_name=='Mechanic Services' || $template_name=='Mechanic Contact' || $template_name=='Taxi Home' || $template_name=='Taxi About' || $template_name=='Taxi Services' || $template_name=='Taxi Reviews' || $template_name=='Taxi Contact' || $template_name=='Woman Home' || $template_name=='Woman About' || $template_name=='Woman Services' || $template_name=='Woman Contacts'){
